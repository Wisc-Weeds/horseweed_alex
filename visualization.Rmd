...
data3 %>% 
  ...
  labs(title = "<b style='color:darkgreen;'>Horseweed</b> response to herbicides", 
       subtitle = "The figure shows the level of <b style='color:darkgreen;'>horseweed</b> control with 9 herbicides from 8 sites of action. Low level of <br>imazethapyr (#2) and glyphosate (#9) control are a concern for herbicide resistance in <b style='color:darkgreen;'>horseweed</b> populations. <br>Group #4 (2,4-D and dicamba) and mesotrione (#27) have reduced <b style='color:darkgreen;'>horseweed</b> control in most<br> populations surveyed.",
...
```{r}
ggplot(data4, mapping = aes(x = long, y = lat, group = group)) + 
  ...
  xlim(-93, -86.5) +
  labs(fill = "County",
       title = "<b style='color:darkgreen;'>Horseweed</b> populations identification",
       subtitle = "18 <b style='color:darkgreen;'>horseweed</b> populations were harvested in <b style='color:#c5050c;'>Wisconsin</b> and 3 populations in <b style='color:#13294B;'>Illinois</b>") +
...
geom_polygon(aes(group = group, fill = county), color="grey") +
